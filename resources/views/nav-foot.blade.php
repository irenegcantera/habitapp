...
<body class="d-flex flex-column h-100 bg-light">
  <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-white border-bottom">
    <div class="container">   
      ...
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo02" aria-controls="offcanvasNavbar">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              @if (!auth()->check())
                <li class="nav-item mt-2 me-3">
                  <a class="nav-link btn" href="{{ route('login') }}">Iniciar sesión</a>
                </li>
                <li class="nav-item mt-2 me-3">
      ...
      <div class="row">
        ...
        <div class="col-md">
          <div class="row">
              ...
              <a id="social-media" href="https://www.linkedin.com/">
                <svg class="bi flex-shrink-0 me-2" width="25" height="25" role="img">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-linkedin">
                    <symbol id="bi-linkedin" fill="currentColor" viewBox="0 0 16 16">
            ...
            <div class="col-2">
              <a id="social-media" href="https://es-es.facebook.com/">
                <svg class="bi flex-shrink-0 me-2" width="25" height="25" role="img">
                  {{-- FACEBOOK --}}
                  <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-facebook">
                    <symbol id="bi-facebook" fill="currentColor" viewBox="0 0 16 16">
            ...
            <div class="col-2">
              <a id="social-media" href="https://twitter.com/">
                <svg class="bi flex-shrink-0 me-2" width="25" height="25" role="img">
                  {{-- TWITTER --}}
                  <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-twitter">
                    <symbol id="bi-twitter" fill="currentColor" viewBox="0 0 16 16">
                      <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"/>
                    </symbol>
                  </svg>
                  <use xlink:href="#bi-twitter"/>
                </svg>
              </a>
            </div>
            <div class="col-2">
              <a id="social-media" href="https://www.instagram.com/">
                <svg class="bi flex-shrink-0 me-2" width="25" height="25" role="img">
                    {{-- INSTAGRAM --}}
                  <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-instagram">
                    <symbol id="bi-instagram" fill="currentColor" viewBox="0 0 16 16">
