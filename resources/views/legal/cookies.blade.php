...
@section('title','HabitApp - Política de Coookies')

@section('content')

<div class="img-legal"></div>

<div class="container text-justify mt-5">
    <h1>Política de cookies</h1>
    <p class="mt-4"><span class="fw-bold">HabitApp, S.L.</span> informa acerca del uso de las cookies en su página web: www.habitapp.es</p>
    ...
    <div class="mt-4">
        ...
        <p>Según quien sea la entidad que gestione el dominio desde donde se envían las cookies y trate los datos que se obtengan se pueden
        ...
        <p>En el caso de que las cookies sean instaladas desde un equipo o dominio gestionado por el propio editor pero la información que se
            recoja mediante éstas sea gestionada por un tercero, no pueden ser consideradas como cookies propias.</p>    
        <p>Existe también una segunda clasificación según el plazo de tiempo que permanecen almacenadas en el navegador del cliente,
    ...
    <div class="mt-4">
        ...
        <p> Tienes la opción de permitir, bloquear o eliminar las cookies instaladas en tu equipo mediante la configuración de las opciones del
        ...
        <p>Puede usted permitir, bloquear o eliminar las cookies instaladas en su equipo mediante la configuración de las opciones del
    ...
    <div class="mt-4">
        <h3>Aceptación</h3>
        <p>En relación con la utilización de cookies de este sitio web, el usuario autoriza y consiente 
            su uso de la siguiente manera: Cuando el usuario accede a la página de la web, verá un aviso donde se indica que utiliza 
            cookies, pudiendo el usuario aceptar o rechazar el uso de estas pulsando el boto de aceptar. Si el usuario no pulsa el botón
            aceptar, y sigue navegando por el sitio web de <span class="fw-bold">HabitApp, S.L.</span> utilizando sus servicios, el usuario 
            acepta el uso que se hacen las cookies necesarias en esta página web.</p> 
    </div>
