                        ...
                        <div class="col-lg-7">
                            ...
                            <div>
                                ...
                                @for($i = 0; $i < $habitaciones_libres; $i++)
                                    <a class="me-3" id="tooltip" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Habitación libre">
                        ...
                        <div class="col-lg-5 mt-5">
                            ...
                            <form action="{{ route('mensajes.store') }}" method="post" enctype="multipart/form-data">
                                @if (auth()->check())
                                    ...
                                    @endif
                                    @if(session('error'))
                                        <div class="alert alert-danger alert-dismissible fade show d-flex align-items-center mt-4" role="alert" id="aviso">
